...
//el isset comprueba que las varibles post estén definidas y !empty que no vengan null
if (isset($_POST) and !empty($_POST)) {
	...
	$res = $datos->insertar_reservas($nombre, $celular, $email, $presupuesto, $destino, $fecha, $observaciones);
		...
		<div class="contenedor-form">
			<form method="post">
				...
				<center>
					...
					<button class="btn btn-danger" onclick="window.location.href='../salir.php'">Salir</button>
